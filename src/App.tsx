...
function App() {
  ...
  const handleUpdateData = async () => {
    ...
    try {
      const response = await fetch(
        "https://servidor-nuvem-lpc.onrender.com/liga"
      );
      if (response.ok) {
  ...
  return (
    <div className="min-h-screen w-screen w-aut flex flex-row justify-center items-center">
      <FaPowerOff
        className={`transform bg-orange-600 size-52 rounded-full ${
